...
if (!cfgCols.includes('attack_panel_channel_id')) {
  try { db.exec('ALTER TABLE guild_config ADD COLUMN attack_panel_channel_id TEXT'); } catch {}
}
if (!cfgCols.includes('attack_panel_message_id')) {
  try { db.exec('ALTER TABLE guild_config ADD COLUMN attack_panel_message_id TEXT'); } catch {}
}
